        ...
        <div className="ExtendedCard">
            ...
            <div className="ExtendedCard__Header" >
                <div className="ExtendedCard__Logo">
                    <img className="ExtendedCard__Image" alt="Brand promo image" src="https://china-review.com.ua/uploads/posts/2017-05/1496088872_mi-store4.jpg" />
                </div>
                <div className="ExtendedCard__Info">
                    <h3 className="brandName">Mi-mi store <span className="discount">-50%</span></h3>
           ...
           <div className="ExtendedCard__Description">
               <h3>Description <span className="">valid until<strong className="validDate">05 May 2021</strong></span> </h3>

                <div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus alias et facilis quia repudiandae sequi? Doloribus id quae rerum tenetur?</p>
                </div>
            </div>
            ...
            <div className="ExtendedCard__Footer">
                ...
                <div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A exercitationem facilis praesentium saepe. Deserunt, perspiciatis.</p>
            </div>
            </div>
